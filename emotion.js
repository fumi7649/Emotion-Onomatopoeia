                ...
                `
                    <div class="d-flex col-md-5 col-12 bg-white px-0 my-2">
                        ...
                        <div class="col-4 px-0 d-flex justify-content-center align-items-center">
                            <img class="col-12 imgFit p-1" src="${words[i].pictureUrl}">
                        </div>
                    </div>
...
function createContainer(emotions){
   let container = 
        `
    ...
    for(let i = 0;i < emotions.length;i++){
        container +=
            `
                <div class="expandLink col-12 col-md-6 col-lg-3 p-4 m-4 text-center" style="background: ${emotions[i].color};">
                    <a href="#${emotions[i].emotion}"></a>
                    <h3 class="text-white">${emotions[i].emotion}</h3>
                    <h1>${emotionIcons[emotions[i].emotion]}</h1>
                    <p class="text-white">${emotions[i].description}</p>
                </div>
            `;
